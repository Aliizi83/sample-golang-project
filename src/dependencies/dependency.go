...
func GetCarModelRepository(cfg *config.Config) repositories.CarModelRepository {
	return postgres_repositories.NewBaseRepository[models.CarModel](cfg,
		[]db.PreloadEntity{{Entity: "Company.Country"}, {Entity: "CarType"}, {Entity: "Gearbox"}, {Entity: "CarModelColors.Color"}})
}

//Generated dependency function

func GetCarModelColorRepository(cfg *config.Config) repositories.CarModelColorRepository {
	return postgres_repositories.NewBaseRepository[models.CarModelColor](cfg, []db.PreloadEntity{{Entity: "Color"}})
}
...
func GetCarModelImageRepository(cfg *config.Config) repositories.CarModelImageRepository {
	return postgres_repositories.NewBaseRepository[models.CarModelImage](cfg, []db.PreloadEntity{})
}
//Generated dependency function

func GetCarModelPropertyRepository(cfg *config.Config) repositories.CarModelPropertyRepository {
	return postgres_repositories.NewBaseRepository[models.CarModelProperty](cfg, []db.PreloadEntity{})
}
//Generated dependency function

func GetCarModelCommentRepository(cfg *config.Config) repositories.CarModelCommentRepository {
	return postgres_repositories.NewBaseRepository[models.CarModelComment](cfg, []db.PreloadEntity{})
}