...
func (z *ZeroLogger) Debug(category Category, subCategory SubCategory, message string, extra map[ExtraKey]interface{}) {
	z.logger.
		Debug().
...
func (z *ZeroLogger) Info(category Category, subCategory SubCategory, message string, extra map[ExtraKey]interface{}) {
	z.logger.
		Info().
		Str("Category", string(category)).
		Str("SubCategory", string(subCategory)).
...
func (z *ZeroLogger) Warning(category Category, subCategory SubCategory, message string, extra map[ExtraKey]interface{}) {
	z.logger.
		Warn().
		Str("Category", string(category)).
		Str("SubCategory", string(subCategory)).
...
func (z *ZeroLogger) Error(err error, category Category, subCategory SubCategory, message string, extra map[ExtraKey]interface{}) {
	z.logger.
		Error().
		Str("Category", string(category)).
		Str("SubCategory", string(subCategory)).
...
func (z *ZeroLogger) Fatal(err error, category Category, subCategory SubCategory, message string, extra map[ExtraKey]interface{}) {
	z.logger.
		Fatal().
		Str("Category", string(category)).
		Str("SubCategory", string(subCategory)).
